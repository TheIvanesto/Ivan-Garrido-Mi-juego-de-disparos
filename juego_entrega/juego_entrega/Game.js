...
class Game {
    ...
    endGame () {
        this.ended = true;
        // Mostrar un overlay de GAME OVER en rojo
        try {
            ...
            overlay.innerHTML = `
              ...
              <div style="margin-top:16px;text-align:center;">
                <button id="overlay-restart" class="gamebutton">JUGAR OTRA VEZ</button>
              </div>
            `;
            document.body.appendChild(overlay);
            // attach handler to restart without relying on global reload
            ...
            // Fallback: si no se puede crear el overlay, mostrar imagen de game over
